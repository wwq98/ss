    ...
    var Controller = {
        index: function() {
            ...
            $(".btn-fiapro").on('click', function() {
                ...
                Fast.api.ajax({
                    type: 'POST',
                    url: 'reserve/piliang?ids=' + checkids
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [{
                        ...
                        {
                            field: 'academytext',
                            title: __('Academytext'),
                            operate: 'LIKE'
                        },
                        {
                            field: 'outtimetext',
                            title: __('Outtimetext'),
                            operate: 'LIKE'
                        },
                        {
                            field: 'backtimetext',
                            title: __('Backtimetext'),
                            operate: 'LIKE'
                        },
